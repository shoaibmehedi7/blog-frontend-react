    ...
    return (
        <>
            <div className="sidebar">
                <a  className='text-center w-full bg-gray-400 font-bold h-14 text-white hover:bg-green-700 focus:outline-none focus:bg-green-600 focus:ring-4 focus:ring-green-600 focus:ring-opacity-50' href='/categories'>Categories</a>
