        ...
        return (
            ...
            <div className='grid grid-cols-4 max-w-6xl mx-auto px-4 py-12 overflow-hidden'>
                {/* <a href={'react' + '/' + blogDetails.blogDetails.id}> */}
                    <div key={blogDetails.blogDetails.id} class="col-span-3  rounded-lg overflow-hidden shadow-lg hover:bg-gray-100 transition duration-500 ease-in-out transform hover:-translate-y-1 hover:scale-103">
                        ...
                        <div class="px-6 py-4">
                            ...
                            <div class="font-bold text-xl mb-2 cursor-pointer text-green-500 capitalize">{blogDetails.blogDetails.title}</div>
                            <p class="text-gray-700 text-base ">{blogDetails.blogDetails.title + blogDetails.blogDetails.title}</p>
                        </div>
                ...
                {/* </a> */}
                {/* <div class="col-span-3 bg-white rounded-lg overflow-hidden flex flex-col shadow-lg hover:bg-gray-100 transition duration-500 ease-in-out transform hover:-translate-y-1 hover:scale-103">
                    <img class="w-full" src="https://images.unsplash.com/photo-1624555130581-1d9cca783bc0?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=1471&q=80" alt="Mountain" />
                    <div class="px-6 py-4">
                        <p class="text-gray-900 leading-none text-purple-500 mb-2 font-bold">React JS</p>
                        <a href={'react' + '/' + blogDetails.blogDetails.id}><div class="font-bold text-xl mb-2 cursor-pointer text-green-500 capitalize">{blogDetails.blogDetails.title}</div></a>
                        <p class="text-gray-700 text-base ">{blogDetails.blogDetails.title + blogDetails.blogDetails.title + blogDetails.blogDetails.title + blogDetails.blogDetails.title}</p>
                    </div>
                    <div class="px-6 pt-4 pb-2">
                        <span class="inline-block bg-gray-200 rounded-full px-3 py-1 text-sm font-semibold text-gray-700 mr-2 mb-2">#photography</span>
                        <span class="inline-block bg-gray-200 rounded-full px-3 py-1 text-sm font-semibold text-gray-700 mr-2 mb-2">#travel</span>
                    ...
                    <div class="relative flex  px-6 pt-4 pb-2">
                        <img class="w-10 h-10 rounded-full mr-4" src="https://www.w3schools.com/howto/img_avatar.png" alt="Avatar of Writer" />
                        <div class="text-sm">
                            <p class="text-gray-900 leading-none">John Smith</p>
                            <p class="text-gray-600">Aug 18</p>
                ...
                <div className='content-center	mx-4'>
                    {blogs.countries.map(item => {
                        return <div class="mb-4 w-full bg-white rounded-lg overflow-hidden flex flex-col shadow-lg hover:bg-gray-100 transition duration-500 ease-in-out transform hover:-translate-y-1 hover:scale-103">
                            <img class="w-full" src="https://images.unsplash.com/photo-1624555130581-1d9cca783bc0?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=1471&q=80" alt="Mountain" />
                            <div class="px-6 py-4">
                                <p class="text-gray-900 leading-none text-purple-500 mb-2 font-bold">React JS</p>
